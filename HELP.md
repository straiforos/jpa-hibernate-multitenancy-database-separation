...
* The original package name 'traiforce.group.llc..jpa-hibernate-multitenancy-database-separation' is invalid and this project uses 'traiforce.group.llc.jpa_hibernate_multitenancy_database_separation' instead.
...
* [Spring Configuration Processor](https://docs.spring.io/spring-boot/docs/3.4.0-M3/reference/htmlsingle/index.html#appendix.configuration-metadata.annotation-processor)
